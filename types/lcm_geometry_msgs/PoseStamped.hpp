...
#ifndef __lcm_geometry_msgs_PoseStamped_hpp__
#define __lcm_geometry_msgs_PoseStamped_hpp__
...
uint64_t PoseStamped::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0x8d16b335dc28302aLL;
