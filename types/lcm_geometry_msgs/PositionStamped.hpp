...
#ifndef __lcm_geometry_msgs_PositionStamped_hpp__
#define __lcm_geometry_msgs_PositionStamped_hpp__

#include <lcm/lcm_coretypes.h>

#include <string>

namespace lcm_geometry_msgs
{

class PositionStamped
{
    public:
        std::string name;
...
int PositionStamped::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int PositionStamped::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int PositionStamped::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t PositionStamped::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* PositionStamped::getTypeName()
{
    return "PositionStamped";
}

int PositionStamped::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int PositionStamped::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int PositionStamped::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t PositionStamped::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0xc749088b75fbd6f6LL;
